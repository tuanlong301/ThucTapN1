...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.VH> {
    ...
    public void onBindViewHolder(@NonNull VH h, int pos) {
        ...
        // Tổng tiền
        h.tvTotal.setText("Tổng: " + CurrencyUtils.formatVnd(o.total));

        // Payment line (phương thức + trạng thái tiền)
        if (h.tvPayment != null) {
            String pm = (o.paymentMethod == null ? "?" : o.paymentMethod);
            String pst;
            if (Constants.PAY_PAID.equalsIgnoreCase(o.paymentStatus)) pst = "Đã thanh toán";
            else if (Constants.PAY_AWAITING_TRANSFER.equalsIgnoreCase(o.paymentStatus)) pst = "Chờ chuyển khoản";
            else if (Constants.PAY_UNPAID.equalsIgnoreCase(o.paymentStatus)) pst = "Chưa thu";
        ...
        if (mode == Mode.PENDING) {
            ...
            boolean isPaid = Constants.PAY_PAID.equalsIgnoreCase(o.paymentStatus);
